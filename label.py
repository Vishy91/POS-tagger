...
print "Learning model to understand the data this has three models. first is a simplified version second is HMM.vaishnavi is testing. hellooooo this is crap."
solver = Solver()
